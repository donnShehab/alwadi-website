  ...
  return (
    <section id={id} className="bg-brand-white section-padding overflow-hidden">
      <div className="max-width-container">
        ...
        <div className="mb-32 flex flex-col items-start max-w-4xl interactive">
           <div className="flex items-center gap-6 mb-10">
              <span className="text-tagline !mb-0">{category} Masterpieces</span>
              <div className="w-16 h-px bg-brand-orange/20" />
           </div>
           <h2 className="!leading-[0.85] mb-12">
             The <span className="text-brand-orange">{category}</span> <br /> 
             <span className="text-serif lowercase opacity-70 italic">Series.</span>
           </h2>
           <p className="text-2xl text-brand-gray-dark/50 font-medium leading-tight tracking-tight max-w-2xl">
        ...
        <div className="mt-40 pt-20 border-t border-brand-gray-mid/20 flex justify-center">
           <div className="text-[10px] font-black uppercase tracking-[0.5em] text-brand-gray-dark/20">
